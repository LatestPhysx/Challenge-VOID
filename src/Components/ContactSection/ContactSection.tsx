...
const ContactSection = () => {
    return (
        <motion.div initial={{ x: 300 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.4, ease: "backInOut" }} animate={{ x: 0 }} className='w-full py-24 px-16 flex flex-col gap-5 items-center text-center justify-center bg-[linear-gradient(90deg,#DC2626_0%,#B01219_100%)]'>
